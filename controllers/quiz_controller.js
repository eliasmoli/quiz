...
exports.index = function(req, res) {
   ...
   if (req.query.search) {
      ...
      // SELECT `id`, `pregunta`, `respuesta`, `createdAt`, 
      //`updatedAt` FROM `Quizzes` AS `Quiz` WHERE pregunta like '%de%gal%' 
      ...
      function(err){
         if (err) {
            ...
            quiz.save({fields: ["pregunta", "respuesta", "tema"]}).then(function(){
               console.log("Pregunta creada:" + quiz.pregunta + " - " + quiz.respuesta + " - " + quiz.tema);
